...
TrelloPowerUp.initialize(
{
  ...
  {
    // options.entries es una lista de los archivos adjuntos para esta tarjeta
    // usted puede mirar a traves de ellos y "reclamar" cualquier que desee
    // incluida en su seccion.
